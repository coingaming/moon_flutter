...
///       shape: const SquircleBorderNew(cornerRadius: 75.0),
...
/// {@end-tool}
///
/// The image below depicts a [SquircleBorderNew] with a width
...
class SquircleBorderNew extends ShapeBorder {
  ...
  @override
  ShapeBorder scale(double t) => SquircleBorderNew(cornerRadius: cornerRadius * t);

  @override
  ShapeBorder lerpFrom(ShapeBorder? a, double t) {
    if (a is SquircleBorderNew) {
      return SquircleBorderNew(cornerRadius: ui.lerpDouble(a.cornerRadius, cornerRadius, t)!);
    }
  ...
  ShapeBorder lerpTo(ShapeBorder? b, double t) {
    if (b is SquircleBorderNew) {
      return SquircleBorderNew(cornerRadius: ui.lerpDouble(cornerRadius, b.cornerRadius, t)!);
    }
  ...
  bool operator ==(Object other) {
    ...
    return other is SquircleBorderNew && cornerRadius == other.cornerRadius;
  }
