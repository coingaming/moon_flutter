...
class MoonModal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color effectiveTextColor =
        context.moonTheme?.modalTheme.colors.textColor ?? MoonTextTheme(tokens: MoonTokens.light).colors.bodyPrimary;

    final Color effectiveIconColor =
        context.moonTheme?.modalTheme.colors.iconColor ?? MoonIconTheme(tokens: MoonTokens.light).colors.primaryColor;

    final TextStyle effectiveTextStyle =
        context.moonTheme?.modalTheme.properties.textStyle ?? MoonTokens.light.typography.body.textDefault;
